//Программа парсит сайт drom.ru и выводит результат в JTable
...
public class ParsingWeb {
    public static void main(String[] args) throws IOException  {
        ...
        Object[] column = new String[]{"Название", "Ссылка", "Цена", "Пробег"}; //заголовки для столбцов
        tableModel.setColumnIdentifiers(column); //определение столбцов
        for (int i = 0; i < list.size(); i++) { //заполнение модели данными
